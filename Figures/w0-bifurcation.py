...
critical_r03 = find_critical_w0(r_03, I_0, initial_guess=10)
...
plt.axvline(x=critical_r03, color='black', linestyle='--', label='Critical w0 for r03 = ' + f'{critical_r03}')
plt.axvline(x=critical_r04, color='brown', linestyle='--', label='Critical w0 for r04 = ' + f'{critical_r04}')

plt.xlabel('$w_0$')
plt.ylabel('Response')
plt.title(f'Bifurcation Diagram at $I_0 = {I_0:.2f}$')
plt.legend()
plt.grid(True)
plt.show()
